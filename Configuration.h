...
#define TEMP_SENSOR_0 20 // 5 original, 20 pt100
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 280 // original 300, updated 280
#define Y_MAX_POS 280 // original 300, updated 280
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define AUTO_BED_LEVELING_GRID
    ...
    #define RIGHT_PROBE_BED_POSITION 247 // original 265
    #define FRONT_PROBE_BED_POSITION 0
    #define BACK_PROBE_BED_POSITION 247 // original 280
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -1.6  // original was -1.6  // Z probe to nozzle Z offset: -below (always!)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.19,80.19,1600,102.3}  // default steps per unit for Ultimaker, e original = 90, z original 800
